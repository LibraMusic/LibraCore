...
func V1Playables(c *fiber.Ctx) error {
	...
	if err != nil {
		logging.Error("Error getting playables", "err", err)
	}
...
func V1Track(c *fiber.Ctx) error {
	...
	if err != nil {
		logging.Error("Error getting track", "err", err, "trackID", trackID)
	}
	return c.JSON(track)
}
...
func V1Video(c *fiber.Ctx) error {
	...
	if err != nil {
		logging.Error("Error getting video", "err", err, "videoID", videoID)
	}
	return c.JSON(video)
}
